...
@Injectable()
export class MockGcpService {
  private drive: drive_v3.Drive
  private docs: docs_v1.Docs
  private sheets: sheets_v4.Sheets

  constructor(private configService: ConfigService) {
    console.log('creating a mock gcp service')
  }
  ...
  async createDocument(title: string) {
    ...
    return new ApiResponseDto('Documento creado con éxito', id)
  }
  ...
  async createDocumentByParentId(title: string, parentId: string) {
    ...
    const id = Math.random().toString(36).substring(7)
    return new ApiResponseDto('Subdocumento creado con éxito', id)
  }
