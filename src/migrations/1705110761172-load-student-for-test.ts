  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const studentsForTest = [
      ...
      },
      {
        ...
        outlookEmail: 'carlos.garcia@uta.edu.ec',
        personalEmail: 'tony.garcia@gmail.com',
        phoneNumber: '0987456123',
        regularPhoneNumber: '265432',
        dni: '1723456789',
        registration: '2021',
        folio: '2024',
        gender: GENDER.MALE,
        ...
        canton: { id: 1 },
        vinculationHours: 250,
        internshipHours: 300,
        approvedCredits: 300,
        isActive: true,
        bachelorDegree: 'Bachiller en Ciencias Exactas',
        startStudiesDate: new Date('2021-03-01'),
        career: { id: 1 },
      },
      {
        firstName: 'María',
        ...
        outlookEmail: 'maria.ruiz@uta.edu.ec',
        personalEmail: 'elena.rs@gmail.com',
        phoneNumber: '0987654312',
        regularPhoneNumber: '354678',
        dni: '1725123456',
        registration: '2022',
        folio: '2025',
        gender: GENDER.FEMALE,
        ...
        isActive: true,
        bachelorDegree: 'Bachiller en Artes',
        startStudiesDate: new Date('2022-05-01'),
        career: { id: 2 },
      },
      {
        firstName: 'Jorge',
        ...
        outlookEmail: 'jorge.alvarez@uta.edu.ec',
        personalEmail: 'jorge.at@gmail.com',
        phoneNumber: '0987653421',
        regularPhoneNumber: '234567',
        dni: '1726345789',
        registration: '2023',
        folio: '2026',
        gender: GENDER.MALE,
        ...
        canton: { id: 3 },
        vinculationHours: 270,
        internshipHours: 390,
        approvedCredits: 310,
        isActive: true,
        bachelorDegree: 'Bachiller en Ciencias Sociales',
        startStudiesDate: new Date('2023-07-01'),
        career: { id: 3 },
      },
      {
        firstName: 'Lucía',
        ...
        outlookEmail: 'lucia.moreno@uta.edu.ec',
        personalEmail: 'lucia.cb@gmail.com',
        phoneNumber: '0982345678',
        regularPhoneNumber: '456123',
        dni: '1701234567',
        registration: '2024',
        folio: '2027',
        gender: GENDER.FEMALE,
        ...
        canton: { id: 4 },
        vinculationHours: 290,
        internshipHours: 410,
        approvedCredits: 330,
        isActive: true,
        bachelorDegree: 'Bachiller en Letras',
        startStudiesDate: new Date('2024-11-01'),
        career: { id: 4 },
      },
      {
        firstName: 'Pedro',
        ...
        secondLastName: 'Quintana',
        outlookEmail: 'pedro.vargas@uta.edu.ec',
        personalEmail: 'manuel.vq@gmail.com',
        phoneNumber: '0978654321',
        regularPhoneNumber: '567891',
        dni: '1712345678',
        registration: '2025',
        folio: '2028',
        gender: GENDER.MALE,
        birthdate: new Date('2002-12-22'),
        canton: { id: 5 },
        vinculationHours: 300,
        internshipHours: 420,
        approvedCredits: 340,
        isActive: true,
        bachelorDegree: 'Bachiller en Ciencias Naturales',
        startStudiesDate: new Date('2025-12-01'),
        career: { id: 5 },
      },
      {
        firstName: 'Sofía',
        ...
        outlookEmail: 'sofia.martinez@uta.edu.ec',
        personalEmail: 'sofia.mg@gmail.com',
        phoneNumber: '0976543210',
        regularPhoneNumber: '678902',
        dni: '1723456780',
        registration: '2026',
        folio: '2029',
        gender: GENDER.FEMALE,
        ...
        isActive: true,
        bachelorDegree: 'Bachiller en Ciencias Exactas',
        startStudiesDate: new Date('2026-01-01'),
        career: { id: 6 },
      },
      {
        firstName: 'Ana',
        secondName: 'Beatriz',
        firstLastName: 'Dominguez',
        secondLastName: 'Castro',
        outlookEmail: 'ana.dominguez@uta.edu.ec',
        personalEmail: 'beatriz.dc@gmail.com',
        phoneNumber: '0987654326',
        regularPhoneNumber: '789012',
        dni: '1787654321',
        registration: '2027',
        folio: '2030',
        gender: GENDER.FEMALE,
        birthdate: new Date('2002-03-14'),
        canton: { id: 1 },
        vinculationHours: 250,
        internshipHours: 300,
        approvedCredits: 360,
        isActive: true,
        bachelorDegree: 'Bachiller en Ciencias',
        startStudiesDate: new Date('2027-03-01'),
        career: { id: 1 },
      },
      {
        firstName: 'Roberto',
        ...
        firstLastName: 'Perez',
        secondLastName: 'Mora',
        outlookEmail: 'roberto.perez@uta.edu.ec',
        personalEmail: 'jose.pm@gmail.com',
        phoneNumber: '0987654327',
        regularPhoneNumber: '890123',
        dni: '1776543210',
        registration: '2028',
        folio: '2031',
        gender: GENDER.MALE,
        birthdate: new Date('2001-07-28'),
        canton: { id: 2 },
        vinculationHours: 280,
        internshipHours: 350,
        approvedCredits: 370,
        isActive: true,
        bachelorDegree: 'Bachiller en Artes',
        startStudiesDate: new Date('2028-07-01'),
        career: { id: 2 },
      },
      {
        firstName: 'Daniela',
        secondName: 'Francisca',
        firstLastName: 'Guerrero',
        secondLastName: 'Lara',
        outlookEmail: 'daniela.guerrero@uta.edu.ec',
        personalEmail: 'francisca.gl@gmail.com',
        phoneNumber: '0987654328',
        regularPhoneNumber: '901234',
        dni: '1765432109',
        registration: '2029',
        folio: '2032',
        gender: GENDER.FEMALE,
        ...
        isActive: true,
        bachelorDegree: 'Bachiller en Ciencias Sociales',
        startStudiesDate: new Date('2029-10-01'),
        career: { id: 3 },
      },
      {
        firstName: 'Miguel',
        ...
        outlookEmail: 'miguel.navarro@uta.edu.ec',
        personalEmail: 'ricardo.nf@gmail.com',
        phoneNumber: '0987654329',
        regularPhoneNumber: '012345',
        dni: '1754321098',
        registration: '2030',
        folio: '2033',
        gender: GENDER.MALE,
        ...
        isActive: true,
        bachelorDegree: 'Bachiller en Letras',
        startStudiesDate: new Date('2030-08-01'),
        career: { id: 4 },
      },
    ]
